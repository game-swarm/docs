...
| 类别 | 数量 | 说明 |
|------|:----:|------|
| ✅ 已完成 | 25 | P0-1~P0-6, P0-7~P0-8, P1-1~P1-4, P2-1, P2-4, P2-6, S07, S08, S27, S28, economy(688行), global_storage(189行), depot_repair(315行), controller_repair(244行,drone age), security(515行) |
| ⚠️ 部分/Stub | 10 | P3-1(274行), P3-6(267行), S09(21行), S10(43行), S15(28行), S24(88行), S25(9行), S26(19行), S29(0行), P4-1(623行) |
| ❌ 缺失 | 16 | P2-2,P2-5,P2-7,P2-8, S14,S16-S23, P3-7,P3-8, P1-6,P1-7, P4-2~P4-5, P5-1~P5-7 |
