...
详见 `specs/core/01-tick-protocol.md`、`specs/core/10-incremental-snapshot.md`、`specs/core/05-persistence-contract.md`。", "path": "/data/swarm/docs/specs/core/11-shard-protocol.md"}