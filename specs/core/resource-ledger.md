...
| `ContractSettlement` | Contract → Participants | 合约结算（独立 extension surface） |
...
## 7. 独立 extension Surface

以下入口不属于 active Resource Ledger：

| 入口 | 状态 | 替代方案 |
|------|------|---------|
| Contract Settlement | extension | Challenge Board 用非资源奖励 |
| Merchant NPC | extension | — |
| Drone P2P Offer | extension | Allied Transfer (受限) 部分覆盖 |
