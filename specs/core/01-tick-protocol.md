...
Phase 2b 完成后:
  ...
  1. 对每个活跃房间：独立 FDB 事务写入 content-addressed staging 键空间
  ...
  4. GlobalTickCommit（唯一 publish 点 — FDB 原子事务，manifest-only）:
