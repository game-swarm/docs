...
所有 MCP 工具在此注册。**共计 46 个活跃工具** (game_api) + **11 个 Auth API 工具** (auth_api)。v0.3.0：swarm_list_market_orders 移至 RFC；新增 Auth category。

**来源 IDL**: game_api.idl.yaml (46 tools), auth_api.idl.yaml (11 auth tools)
