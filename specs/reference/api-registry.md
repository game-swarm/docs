...
**来源 IDL**: game_api.idl.yaml (57 tools), auth_api.idl.yaml (12 auth tools — R33 B4 证书链模型)
...
|--------|-------------|---------------|------------|----------------|----------------|--------------|-------------------|----------------|----------|---------------|----------|
| `swarm_register_challenge` | `{}` | `{challenge_id, challenge, difficulty_bits, expires_at}` | 10/min | `none` | `none` | `non_replayable` | `none` | `per_ip` | game_api | `auth_api` | `auth_api.swarm_register_challenge` |
...
|--------|-------------|---------------|------------|----------------|----------------|--------------|-------------------|----------------|
| `swarm_register_challenge` | `{}` | `{challenge_id, challenge, difficulty_bits, expires_at}` | 10/min | `none` | `none` | `non_replayable` | `none` | `per_ip` |
| `swarm_submit_csr` | `{username, csr, certificate_profile, device_label, challenge_id, nonce, csr_signature, email?, recovery_password?}` | `{certificate_bundle: {client_auth_cert, code_signing_cert, cert_id, player_id, public_key_fingerprint, issued_at, expires_at}}` | 1/30s | `none` | `none` | `non_idempotent_mutation` | `none` | `per_ip` |
...
| **CSR challenge default difficulty** | **20 bits** | world.toml 可配 |
