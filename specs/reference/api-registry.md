...
> **RFC-TOURNAMENT** / **RFC-LEADERBOARD**: Tournament/League 为 P1+ 上层编排，leaderboard 为 Product 扩展项。这些工具 schema 在当前 IDL 中保留但不实现——返回 `ERR_FEATURE_GATED`。P0 仅提供 `swarm_match_result`（房间赛后摘要）。
