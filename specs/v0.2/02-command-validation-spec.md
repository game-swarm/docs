...
## 10. v0.2 新增 CommandAction (2026-06-15)
...
```
- 校验: drone 有 RangedAttack body part, target 在射程内
- 伤害: parts × 25, 范围 3
...
```
- 校验: drone 有 Claim body part, target 是 Controller, 范围 1
- 效果: 夺取 Controller ownership
...
```
- 效果: 回收 drone, 退还 50% body part 资源
- Tutorial 世界前 500 tick 退还 100%

### 10.4 特殊攻击

| 攻击 | body part | 冷却 | 消耗 | 抗性 |
|------|----------|------|------|------|
| Disrupt | Attack | 50 tick | 100E | Sonic |
| Fortify | Tough | 300 tick | 400E | — (增益) |
| Hack | Claim | 200 tick | 1000E | Psionic |
| Drain | Carry+Work | 50 tick | 200E/tick | EMP |
| Overload | RangedAttack | 200 tick | 300E | EMP |
| Debilitate | Work | 150 tick | 200E | Corrosive |
| Leech | custom | — | 300E | Corrosive |
| Fabricate | custom | 500 tick | 2000E+500M | — |
