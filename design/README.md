...
| **游戏机制** | [`design/gameplay.md`](gameplay.md) | Vanilla Ruleset、身体部件、伤害类型、特殊攻击（8 种）、经济模型、Controller/建筑系统；平衡表见 [`economy-balance-sheet.md`](economy-balance-sheet.md)，权威公式见 [`resource-ledger.md`](../specs/core/resource-ledger.md) |
