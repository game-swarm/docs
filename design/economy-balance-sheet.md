...
| 房间数 | 收入/tick | 维护费/tick | 存储税/tick | 净流量/tick | 说明 |
|:------:|:--------:|:---------:|:---------:|:---------:|------|
| 1 | 25 | 55 | 0 | **-30** | 需要初始资源包支撑 |
| 2 | 55 | 120 | 0 | **-65** | 双房间起步，快速扩张期 |
| 3 | 85 | 195 | 0 | **-110** | 开始需要 Harvester 优化 |
| 5 | 140 | 375 | 15 | **-250** | 需要优化 Harvester 代码效率 |
| 10 | 560 | 1,000 | 45 | **-485** | 需要多 Source 并行 + 代码效率 |
| 20 | 1,220 | 3,000 | 120 | **-1,900** | 需要高效经济 + PvE 收益 |
| 50 | 3,975 | 15,000 | 600 | **-11,625** | 硬上限逼近，顶尖玩家维持 |
