...
以下汇总表提供 1/2/3/5/10/20/50 房间的收支对比。**所有数值为估值，精确数值由 Resource Ledger §Empire Upkeep + StorageTax 公式实时计算。** 利用率假设：1-3 房间 <30% 存储（免税），5 房间 ~40%，10 房间 ~55%，20 房间 ~70%，50 房间 ~90%。

| 房间数 | 收入/tick (基础) | 收入/tick (优化 ×1.5) | 维护费/tick | 存储税/tick | 净流量/tick (基础) | 净流量/tick (优化) | 说明 |
|:------:|:--------:|:--------:|:---------:|:---------:|:---------:|:---------:|------|
| 1 | 22 | 22 | 0¹ | 0 | **+22**¹ | **+22**¹ | free_upkeep 纯盈余 |
| 2 | 48 | 66 | 120 | 0 | **-72** | **-54** | 快速扩张期，需升级 RCL |
| 3 | 72 | 99 | 195 | 0 | **-123** | **-96** | Harvester 优化开始见效 |
| 5 | 140 | 195 | 375 | 15 | **-250** | **-195** | 代码效率成为关键差异化 |
| 10 | 560 | 820 | 1,000 | 45 | **-485** | **-225** | 2× 效率可趋近平衡 |
| 20 | 1,220 | 1,680 | 3,000 | 120 | **-1,900** | **-1,480** | 需要高效经济 + PvE 收益 |
| 50 | 3,975 | 5,412 | 15,000 | 600 | **-11,625** | **-11,188** | 软上限逼近，顶级玩家维持 |
